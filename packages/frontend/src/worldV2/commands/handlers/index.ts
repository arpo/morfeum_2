...
export { handleGoInsideCommand } from './goInsideHandler';
export { handleGotoCommand } from './gotoHandler';
export { handleLookCommand } from './lookHandler';
...
export { handleRedrawCommand } from './redrawHandler';
