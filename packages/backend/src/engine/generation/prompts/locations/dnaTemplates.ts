/**
 * DNA Generation Template Constants
 * 
 * Template sections for complete DNA generation prompt.
 * Extracted from completeDNAGeneration.ts for maintainability.
 */

export const VISUAL_ANALYSIS_TEMPLATE = (visualAnalysis: any) => `
...
export const OUTPUT_STRUCTURE_SECTION = `OUTPUT STRUCTURE:
...

{
  "host": {
    ...
    "dominantElements": ["Dominant element 1", "Dominant element 2", "Dominant element 3"],
  ...
  "regions": [
    {
      ...
      "dominantElements": ["Regional dominant 1", "Regional dominant 2"],
  ...
  "locations": [
    {
      ...
      "navigableElements": ["wooden door", "stone archway", "iron gate"],
      "dominantElements": ["large chandelier", "marble fountain", "ornate throne"],
...
export const CRITICAL_GUIDELINES_SECTION = `CRITICAL GUIDELINES
