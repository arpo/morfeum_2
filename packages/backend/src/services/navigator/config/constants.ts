 ...
 * Matches formats: spawn-*, subloc-*, loc-*, world-*, region-*
 */
export const VALID_ID_PATTERN = /^(spawn|subloc|loc|world|region)-\d+-[a-z0-9]+$/;
...
export const ERROR_MESSAGES = {
  ...
  NO_PARENT_AVAILABLE: "You're already at the top level of this world. There's nowhere to exit to.",
